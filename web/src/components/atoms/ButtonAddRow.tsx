...
export const ButtonAddRow = () => {
  ...
  return (
    ...
    >
        <span 
        className="absolute w-12 h-12 -right-6 flex justify-center items-center rounded-lg text-content-h font-sans text-lg bg-white group-hover:scale-95 transition"
        >+</span>
          </button>
  );
};
