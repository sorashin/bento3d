...
export const DimElement: FC<DimElementProps> = ({
  value,
  onChange,
  isVertical,
}) => {
  ...
  return isVertical ? (
    // 縦方向
    <p
      className="absolute w-4 h-auto inset-y-0 overflow-visible -left-8 text-center border-y-[1px] border-content-h text-content-h flex flex-col items-center"
