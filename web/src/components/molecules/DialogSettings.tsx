  ...
  return (
    <Dialog isOpen={isOpen} onClose={() => setIsOpen(false)}>
      <div className='flex flex-col gap-4 px-8 py-8 font-display'>
        ...
        <div className="flex items-center justify-between">
          <p className="flex gap-2 items-center text-sm text-content-h"><Icon className="w-6 h-6" name='caseIcon' />Case Preview</p>
          <div className="flex items-center gap-4">
        ...
        <div className="flex items-center justify-between">
          <p className="flex gap-2 items-center text-sm text-content-h"><Icon className="w-6 h-6" name="stack"/>Stackable</p>
          <div className="flex items-center gap-4">
