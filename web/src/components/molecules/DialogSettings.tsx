    ...
    <Dialog isOpen={isOpen} onClose={() => setIsOpen(false)}>
      <div className='flex flex-col gap-4 px-8 py-8'>
        ...
        <div className="flex items-center justify-between">
          <p className="flex gap-2 items-center text-sm text-content-h"><img className="w-6 h-6" src='/icons/thickness.svg' alt=''/>Thickness</p>
          <div className="flex items-center gap-4">
            ...
            <input value={boxConfig.partitionThickness} className="w-32 h-fill p-2 bg-content-xl-a rounded-sm"></input>
            <PrimaryButton onClick={()=>updateThickness(boxConfig.partitionThickness+.1)} width={40} height={40} bgColor={"rgba(0,0,0,.08)"}>+</PrimaryButton>
          </div>
        </div>
        <div className="flex items-center justify-between">
          <p className="flex gap-2 items-center text-sm text-content-h"><img className="w-6 h-6" src='/icons/case.svg' alt=''/>Case Preview</p>
          <div className="flex items-center gap-4">
        ...
        <div className="flex items-center justify-between">
          <p className="flex gap-2 items-center text-sm text-content-h"><img className="w-6 h-6" src='/icons/stack.svg' alt=''/>Stackable</p>
          <div className="flex items-center gap-4">
